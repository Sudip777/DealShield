...
public class ConsumersController : ControllerBase
{
    ...
    [HttpPost("register")]
    [AllowAnonymous]
    public async Task<IActionResult> CreateUser(CreateConsumerRequest request)
    {
        var command = new CreateConsumerCommand(request.FirstName, request.LastName, request.Email, request.Password, request.Phone, request.LowCostPref, request.TrustPref);
